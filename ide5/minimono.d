module minimono;
/*
	MiniMono, MiniM Embedded Edition	(C) Eugene Karataev
...
extern (Windows) {
	alias @nogc int function(ZDLLCB *cbfunc, MINIM_STR **param_pairs, int param_pairs_count) dlldevuse_t;
	alias /* @nogc */ int function(ZDLLCB *cbfunc, int len, int timeout, MINIM_STR *result) dlldevreadstr_t;
	alias @nogc int function(ZDLLCB *cbfunc, int timeout, int *result) dlldevreadchar_t;
	alias /* @nogc */  int function(ZDLLCB *cbfunc, MINIM_STR *str) dlldevwritestr_t;
	alias /* @nogc */ int function(ZDLLCB *cbfunc, int _char) dlldevwritechar_t;
	alias /* @nogc */ int function(ZDLLCB *cbfunc) dlldevwritenl_t;
	alias @nogc int function(ZDLLCB *cbfunc) dlldevwriteff_t;
	alias @nogc int function(ZDLLCB *cbfunc, int tabcount) dlldevwritetab_t;
	alias @nogc int function(ZDLLCB *cbfunc, int *result) dlldevgetx_t;
	alias @nogc int function(ZDLLCB *cbfunc, int value) dlldevsetx_t;
	alias @nogc int function(ZDLLCB *cbfunc, MINIM_STR *result) dlldevgetkey_t;
	alias @nogc int function(ZDLLCB *cbfunc, MINIM_STR *value) dlldevsetkey_t;
	alias @nogc int function(ZDLLCB *cbfunc, int *result) dlldevzeof_t;
}
struct tagMINIMONOVM
{
 align (1):
	char *DataFile;					// file of the database
	...
	char *LocaleFileName;			// file name with MiniM locale definition or null
...
extern (Windows) {
	...
	alias @nogc nothrow void	function(int set_break)									ctrlbreakvm_t;
	alias @nogc nothrow int  	function(MINIM_STR *List, int pos, MINIM_STR *Element)	mnmlistget_t;
	alias @nogc nothrow int  	function(MINIM_STR *List, int pos, MINIM_STR *Element)	mnmlistset_t;
	alias @nogc nothrow int  	function(MINIM_STR *List)								mnmlistlength_t;
	alias @nogc nothrow int 	function(MINIM_STR *Source, MINIM_STR *Target)			mnmtext_t;
	// -------------------- MiniMsc ------------------------
