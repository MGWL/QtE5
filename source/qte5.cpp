...
// void* pFunQt[500]; 				/// Масив указателей на функции из DLL
...
void dumpString(char* str) {
	for(int i; i != 10; i++) printf(" %d ", (unsigned char)*(str+i));
	printf("\n");
}
//___________________________________________________________________
void test() {
...
void* GetHlib(char const* name) {	return LoadLibrary(name); }
//___________________________________________________________________
...
void QObject::connect(void* obj1, char* ssignal, void* obj2, char* sslot, int type) {
	((t_v__vp_vc_vp_vc_i)pFunQt[27])(obj1, MSS(ssignal, QSIGNAL), obj2, MSS(sslot, QSLOT), type);
	// printf("+++ connect Run %p  %s,  %p,  %s, %d\n", obj1, MSS(ssignal, QSIGNAL), obj2, MSS(sslot, QSLOT), type);
};
...
QApplication::QApplication(int argc, char** argv, int gui) : QObject('a') {
...
QWidget::~QWidget() {
	// printf("--1- QWidget %p\n", QtObj());
	if(QtObj()) { ((t_v__vp)pFunQt[7])(QtObj()); setQtObj(NULL); /* printf("--Del- QWidget\n"); */ }
	// printf("--2- QWidget %p\n", QtObj());
};
...
QFrame::~QFrame() {
	// printf("--1- QFrame %p\n", QtObj());
	if(QtObj()) { ((t_v__vp)pFunQt[42])(QtObj()); setQtObj(NULL); /* printf("--Del- QFrame\n"); */ }
	// printf("--2- QFrame %p\n", QtObj());
};
...
QLabel::~QLabel() {
	// printf("--1- QLabel %p\n", QtObj());
	if(QtObj()) { ((t_v__vp)pFunQt[47])(QtObj()); setQtObj(NULL); /* printf("--Del- QLabel\n"); */ }
	// printf("--2- QLabel %p\n", QtObj());
};
...
QAction::~QAction() {
	// printf("--1- QAction %p\n", QtObj());
	if(QtObj()) { ((t_v__vp)pFunQt[96])(QtObj()); setQtObj(NULL); /* printf("--Del- QAction\n"); */ }
	// printf("--2- QAction %p\n", QtObj());
};
//____________________________________________________________________
...
QPushButton::~QPushButton() {
	// printf("--1- QPushButton %p\n", QtObj());
	if(QtObj()) { ((t_v__vp)pFunQt[23])(QtObj()); setQtObj(NULL); /* printf("--Del- QPushButton\n"); */ }
	// printf("--2- QPushButton %p\n", QtObj());
};
//____________________________________________________________________
...
QBoxLayout::~QBoxLayout() {
	// printf("--1- QBoxLayout %p\n", QtObj());
	if(QtObj()) { ((t_v__vp)pFunQt[37])(QtObj()); setQtObj(NULL); /* printf("--Del- QBoxLayout\n"); */ }
